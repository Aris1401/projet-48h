...
INSERT INTO Regime (designationRegime, description, image, duree, variationPoids) VALUES
('Régime équilibré', 'Régime équilibré avec une répartition adéquate des nutriments.', 'regime_equilibre.jpg', 30, -2),
('Régime protéiné', 'Régime axé sur une consommation élevée de protéines.', 'regime_proteine.jpg', 60, -5),
('Régime végétarien', 'Régime sans viande, basé sur les aliments origine végétale.', 'regime_vegetarien.jpg', 30, -3);
